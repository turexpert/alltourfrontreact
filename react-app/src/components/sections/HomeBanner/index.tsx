      ...
      <div className={styles.banner}>
        <div className={styles.bannerInner}>
          <div className={styles.bannerInfo}>
            <h1>Поиск туров по всем туроператорам</h1>
            {isMobile ? (
              <div className={styles.description}>
                Цены туроператоров или ниже. Поддержка 24/7
              </div>
            ) : (
              <div className={styles.description}>
                Удобно ищите и бронируйте туры по цене туроператоров или ниже
                с профессиональной поддержкой и до, во время и после путешествия.
              </div>
            )}
          </div>
          <div className={styles.search}>
            {isMobile ? (
              <Image 
                src="/assets/images/stub-form-mobile.png" 
                alt="Search form"
                width={350}
                height={400}
              />
              ...
              <Image 
                src="/assets/images/stub-form.png" 
                alt="Search form"
                width={1000}
                height={200}
              />
        ...
        <div className={styles.palm}>
          <Image 
            src="/assets/images/banner/palm.svg" 
            alt="Palm"
            width={400}
            height={500}
          />
